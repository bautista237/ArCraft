 ...
 * (e.g. {@code minecraft:crafting_table}). Item AND block icons come from nerothe's
 * pre-rendered icon API, which serves every item/block exactly as it looks in the inventory
 * (blocks as isometric renders), keyed by plain id. Mobs use an emoji (no per-mob icon CDN).
 *
 * <p>Accessible from templates as {@code @iconService}. Templates should add
 * {@code onerror="this.remove()"} so an occasional missing icon just disappears.
 */
@Service
public class IconService {
    ...
    private static final Map<String, String> MOB_EMOJI = Map.ofEntries(
            ...
            Map.entry("skeleton", "💀"),
            Map.entry("stray", "💀"),
            Map.entry("wither_skeleton", "💀"),
            Map.entry("creeper", "🧨"),
            Map.entry("spider", "🕷"),
            Map.entry("cave_spider", "🕷"),
            Map.entry("enderman", "🟪"),
            Map.entry("ender_dragon", "🐉"),
            Map.entry("wither", "☠"),
            Map.entry("warden", "🟦"),
            Map.entry("elder_guardian", "🐡"),
            Map.entry("guardian", "🐡"),
            Map.entry("blaze", "🔥"),
            Map.entry("ghast", "👻"),
            Map.entry("slime", "🟩"),
            Map.entry("magma_cube", "🟧"),
            Map.entry("piglin", "🐗"),
            Map.entry("hoglin", "🐗"),
            Map.entry("zombified_piglin", "🐗"),
            Map.entry("cow", "🐄"),
            Map.entry("pig", "🐖"),
            Map.entry("sheep", "🐑"),
            Map.entry("chicken", "🐔"),
    ...
    // ── Average icon colour (for pie slices) ─────────────────────────────────
    ...
    public String color(String id)    { return colorForUrl(icon(id)); }
    public String mobColor(String id) { return colorForUrl(mobIcon(id)); }
